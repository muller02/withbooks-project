window.addEventListener("load", function () {
    ...
    var searchBook = this.document.querySelector("#search-book");
    var btn = searchBook.querySelector(".btn");
    var resultList = searchBook.querySelector(".result-list");
    var queryInput = searchBook.querySelector(".query-input");
